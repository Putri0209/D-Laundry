...
<div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control"
                                value="ORD-{{ now()->format('YmdHis') }}" readonly>
                        </div>
                        <div class="mb-3">
    ...
    min="0.1" step="0.1" value="1" style="width:80px">
                            </td>
                            <td class="text-end">
                    ...
                    <div class="col-md-5 offset-md-7">
                        <table class="table table-sm">
                            <tr>
                                ...
                                <td class="text-end fw-bold fs-5 text-success" id="display-total">Rp 0</td>
                            </tr>
                        </table>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="order_change" id="input-change"
                                ...
                                readonly value="0" style="background:#f4faf6">
                        </div>
                    </div>
                </div>
